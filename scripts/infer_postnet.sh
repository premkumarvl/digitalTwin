...
export Video_ID=Hilary
export Wav_ID=tts_output
export Postnet_Ckpt_Steps=6000 # please reach to `docs/train_models.md` to get some tips about how to select an approprate ckpt_steps!
